...
export default function Projects() {
  ...
  const projects = useMemo(
    () => [
      {
        title: "Quickshow",
        link: "https://movie-quickshow.vercel.app/",
        bgColor: "#14364A",
        image: isMobile ? photo1 : img1,
      },
      {
        title: "Forever",
        link: "https://crazy-eccomarce.vercel.app/",
        bgColor: "#FFDAD6",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "ChatApp",
        link: "https://chatting-app-production.onrender.com/login",
        bgColor: "#032A48",
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center">
        ...
        <div className={`relative w-full flex-1 flex items-center justify-center ${isMobile?"-mt-4":""}`}>
          {projects.map((project,idx)=>(
            ...
            className={`absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 transition-all duration-500 ${activeIndex===idx? "opacity-100 z-20":"opacity-0 z-0 sm:z-10"}`}
            ...
            >
             ...
             h-[62vh] sm:h-[66vh]`}
             style={{xIndex:10,transition:"box-shadow 250ms ease"}}
             >
