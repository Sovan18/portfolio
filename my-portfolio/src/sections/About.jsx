...
import sovan from '../assets/so.png'
  ...
  return(
    ...
    className="min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden">
       ...
       <div className='relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12'>
        ...
        >
         <motion.div className='relative w-[160px] h-[160px] md:w-[200px] md:h-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border-[#1cd8d2]/25'
           whileHover={{scale:1.02}}
           transition={{type:"spring",stiffness:200,damping:18}}
         >
           <img src={sovan} alt="" className='absolute inset-0' />
         </motion.div>
         <div className='flex-1 flex-col justify-center text-center md:text-left'>
          ...
          <p className='mt-2 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl' >
            I build scalable, modern applications with a strong focus on clean architecture, delightful UX, and perform. My toolkit C++, 
            React, Node.js,TypeScript, Tailwind CSS, and RestfulAPI-bringing ideas to life from concept to productivity with robust APIs and smooth interfaces. 
          </p>
         ...
         >
             ...
             <p className='mt-4 text-gray-400 text-base sm:text-lg'>I love turing ideas into scalable, user-friendly products that make an impact</p>
         </motion.div>
       </div>
    </section>
  )
