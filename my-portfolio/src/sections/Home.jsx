...
const socials = [
  { Icon: FaXTwitter, label: "X", href: "https://x.com/SovanJana269135" },
  { Icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/sovan-jana-203138317/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Sovan18" }
]
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            {/* Name */}
            <motion.h1
              className="text-4xl sm:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1cd8d2] to-[#302b63] drop-shadow-lg"
