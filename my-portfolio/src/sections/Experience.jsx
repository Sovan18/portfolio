...
function ExperienceItem({exp,idx,start,end,scrollYProgress,layout}){
    ...
    if(layout==="desktop"){
        return(
            <div className='relative flex flex-1 justify-center items-center min-w-0'>
                ...
                <motion.div className={`absolute ${idx%2===0? "-top-8":"-botton-8"} w-[3px] bg-white/40`}
    ...
    return(
      <div className='relative flex items-start'>
        ...
        <motion.article className='bg-gray-900/90 backdrop-blur border border-gray-700/70 rounded-xl p-5 w-[90vw] max-w-sm ml-6 shadow-lg'
        style={{opacity,x}}
        transition={{duration:0.4,delay:idx*0.15}}
        >
                  ...
                  )}
                  {
                    isMobile &&(
                      <div className='relative w-full max-w-md'>
                        ...
                        <div className='relative flex flex-col gap-10 ml-6 mt-6 pb-28'>
                           {experiences.map((exp,idx)=>(
                            <ExperienceItem
                            key={idx}
                           exp={exp}
